    ...
    >
      <defs>
        <linearGradient id="waterGrad" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="rgba(65, 105, 225, 0.2)" />
          <stop offset="100%" stopColor="rgba(65, 105, 225, 0.03)" />
        </linearGradient>
      ...
      <motion.circle cx="300" cy={deckY - 10} r="18" fill="#FFE4A0" filter="url(#sunBloom)"
        animate={{ r: [18, 20, 18] }}
        transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }} />
      <motion.circle cx="300" cy={deckY - 10} r="8" fill="#FFB300" opacity="0.9"
      ...
      <motion.ellipse cx="300" cy={deckY} rx="250" ry="15" fill="rgba(255,179,0,0.04)" />

      <motion.rect x="0" y={deckY + 20} width="600" height="100" fill="url(#waterGrad)" rx="4" />
      <motion.ellipse cx="300" cy={deckY + 25} rx="280" ry="8" fill="rgba(255,179,0,0.03)"
        animate={{ rx: [280, 290, 280], opacity: [0.03, 0.06, 0.03] }}
        transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut' }} />
      {[0, 1, 2].map(i => (
        <motion.line key={`ripple-${i}`}
          x1="60" y1={deckY + 40 + i * 15} x2="540" y2={deckY + 40 + i * 15}
          stroke="rgba(65, 105, 225, 0.1)" strokeWidth="0.5"
...
export default function Hero() {
  return (
    <section style={{
      ...
      background: 'linear-gradient(135deg, #F8F9FF 0%, #E8ECF8 40%, #DEE3F5 70%, #F8F9FF 100%)',
      overflow: 'hidden',
      padding: '120px 40px 80px',
    }}>
      <FloatingOrb size={12} x="10%" y="20%" delay={0} duration={7} color="rgba(65, 105, 225, 0.15)" />
      <FloatingOrb size={8} x="80%" y="15%" delay={1} duration={5} color="rgba(255, 179, 0, 0.12)" />
      <FloatingOrb size={16} x="70%" y="70%" delay={2} duration={8} color="rgba(65, 105, 225, 0.1)" />
      <FloatingOrb size={6} x="20%" y="75%" delay={0.5} duration={6} color="rgba(255, 179, 0, 0.15)" />
      <FloatingOrb size={10} x="50%" y="10%" delay={3} duration={9} color="rgba(65, 105, 225, 0.12)" />
      <FloatingOrb size={14} x="85%" y="50%" delay={1.5} duration={7} color="rgba(255, 179, 0, 0.1)" />
      <FloatingOrb size={8} x="30%" y="40%" delay={2.5} duration={6} color="rgba(65, 105, 225, 0.15)" />
      <FloatingOrb size={20} x="5%" y="55%" delay={4} duration={10} color="rgba(65, 105, 225, 0.08)" />

      <div style={{
        position: 'absolute', inset: 0,
        background: 'radial-gradient(circle at 30% 40%, rgba(65, 105, 225, 0.06) 0%, transparent 50%), radial-gradient(circle at 70% 60%, rgba(255, 179, 0, 0.04) 0%, transparent 50%)',
      }} />
